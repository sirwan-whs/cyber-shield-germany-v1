...
if (!collectedNews || collectedNews.length === 0) {
  console.warn("collectedNews ist leer → benutze Testdaten");

  collectedNews = [
    {
      title: " Test: Cyber Angriff erkannt",
      source: "System",
      link: "",
      pubDate: new Date(),
      isAlert: false,
    ...
    {
      title: " Test: Ransomware in Deutschland",
...
//  HIER EXTRA LOG:
console.log("SETZE NEWS:", collectedNews.length);

this.ctx.allNews = collectedNews;

//  UND NOCH EIN LOG:
setTimeout(() => {
  console.log("CTX NEWS NACH 2s:", this.ctx.allNews);
}, 2000);


    this.ctx.allNews = collectedNews;
    (window as any).__CTX__ = this.ctx;
    console.log("GLOBAL CTX SET:", this.ctx);
